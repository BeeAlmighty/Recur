    ...
    <section className="relative min-h-screen flex items-center justify-center pt-20 pb-32 md:pb-48 overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center flex flex-col items-center">
        ...
        <p className="text-lg md:text-xl text-[#A09880] max-w-2xl mb-10 leading-relaxed">
          The ultimate done-for-you retention engine. Capture diner data, track every Naira they
          spend, and automate tiered loyalty rewards that drive predictable repeat visits.
        </p>

        {/* CTA Area */}
        <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
          <GoldButton onClick={scrollToPricing}>View Pricing Plans</GoldButton>
          <GoldButton
            variant="outline"
            onClick={() =>
