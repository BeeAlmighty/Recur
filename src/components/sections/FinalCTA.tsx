      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        >
          <h2 className="text-4xl md:text-6xl font-display font-bold mb-6">
            Stop losing past customers to{' '}
            <span className="text-[var(--color-gold)] italic">silence.</span>
          </h2>
          <p className="text-xl text-[#A09880] mb-10 max-w-2xl mx-auto">
            Join the top-tier Nigerian restaurants using RECUR to build an automated, profitable
            database. We build it, you profit.
          </p>
