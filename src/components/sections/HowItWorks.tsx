    ...
    <section id="how-it-works" className="py-24 bg-[#0A0A0A]">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-20">
          ...
          >
            A completely hands-off, 4-step retention engine working in the background while you
            focus on the food.
          </motion.p>
        </div>
        ...
        >
          ...
          {steps.map((step, idx) => (
            <motion.div
              ...
              className="relative flex flex-col items-center md:items-start text-center md:text-left pt-8"
            >
              ...
              <p className="text-[#A09880] leading-relaxed">{step.desc}</p>
            </motion.div>
          ))}
        </motion.div>
      </div>
