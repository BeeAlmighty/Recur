        ...
        <div className="flex flex-col md:flex-row justify-between items-center md:items-start gap-8 mb-12">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-sm text-[#A09880] max-w-xs">
              The automated retention engine for Nigerian restaurants. Build your database, increase repeat visits, and dominate local SEO.
            </p>
          </div>

          {/* Contact / Legal */}
          <div className="text-center md:text-right text-sm text-[#A09880]">
            <p className="mb-2">Powered by <span className="text-white font-medium">GeoTech Solutions</span></p>
            <p className="mb-2">Lagos, Nigeria</p>
            <a href="mailto:hello@geotech.com" className="hover:text-[var(--color-gold)] transition-colors">
              hello@geotech.com
            </a>
          </div>
        </div>
