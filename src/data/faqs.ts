export const faqsData = [
  ...
  },
  {
    ...
    answer: "Your custom retention engine will be fully operational within 5 business days from the payment of your setup fee."
  },
  {
    question: "What happens if a customer doesn't have a smartphone?",
    answer: "Our system primarily relies on QR codes, but we also provide a custom short-link that your staff can manually enter into a tablet or POS system if a customer prefers to give their details verbally."
  },
  {
