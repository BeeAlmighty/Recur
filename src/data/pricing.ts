export const pricingData = {
  ...
  cycles: [
    ...
    { id: 'biannual', label: 'Biannual', discount: 0.2, badge: 'Save 20%' }, // 6 Months
  ...
  tiers: [
    ...
    },
    {
      ...
      features: [
        ...
        'Weekly promo campaigns',
        'Custom Loyalty Tiers (Gold, Platinum)',
        '30-day win-back sequences',
    ...
    },
    {
      ...
      features: [
        ...
        'Monthly SMS/Email credits included',
        'WhatsApp promotion',
      ],
    },
  ],
